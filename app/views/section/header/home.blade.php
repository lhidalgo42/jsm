<div id="page_header">
    ...
    <div id="myCarousel" class=" carousel slide" data-ride="carousel"
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                ...
                <div class="container">
                    <div class="carousel-caption">
                        <h2 class="" style="font-size: 60px;"><span class="rotate" id="rot1">{{Info::where('name','titulo1')->get()->first()->value}}
                                ,{{Info::where('name','titulo2')->get()->first()->value}}</span>
                        </h2>
                    </div>
                </div>
            </div>
            @if(isset($images[1]))
                <div class="item">
                    ...
                    <div class="container" s>
                        <div class="carousel-caption">
                            <h2 class="" style="font-size: 60px;color: #f51200">Compramos su<br> <span class="rotate"
                                                                                                       id="rot2">Auto,Camioneta,Furgon,4x4</span>
                            </h2>
                        </div>
                    </div>
                </div>
            ...
            @if(isset($images[4]))
                <div class="item">
                    <img class="third-slide" src="{{$images[4]}}" alt="Third slide">
                </div>
            @endif
            @if(isset($images[5]))
                <div class="item">
                    <img class="third-slide" src="{{$images[5]}}" alt="Third slide">
                </div>
            @endif
        </div>
    </div><!-- /.carousel -->
